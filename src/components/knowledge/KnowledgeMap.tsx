...
import { Edit2, Box, MessageSquare, Star, Tag, Globe } from 'lucide-react';
...
export function KnowledgeMap({ data }: KnowledgeMapProps) {
  ...
  const totalReviews = data <boltAction type="file" filePath="src/components/knowledge/KnowledgeMap.tsx">
'use client';
