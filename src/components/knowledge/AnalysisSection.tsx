...
export function AnalysisSection({ onAnalysisComplete }: AnalysisSectionProps) {
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div>
          ...
          {showHelp && (
            <div className="mb-4 p-4 bg-blue-900/30 rounded-lg text-sm text-blue-200">
          ...
          <div className="relative flex items-center">
            <input
              ...
              className={`w-full px-4 py-3 rounded-lg border focus:ring-2 focus:ring-blue-500 bg-gray-700 text-white placeholder-gray-400
        ...
        {error && (
          <div className="flex items-start gap-2 p-4 bg-red-900/30 rounded-lg">
